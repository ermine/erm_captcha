(* OASIS_START *)
(* DO NOT EDIT (digest: e4fa11d9e2b5d2300d94df45418391e3) *)
...
let package_default =
  {
     MyOCamlbuildBase.lib_ocaml = [("erm_captcha-lib", [])];
     lib_c = [("erm_captcha-lib", ".", [])];
     flags =
       [
          (["oasis_library_erm_captcha_lib_ccopt"; "compile"],
            [
